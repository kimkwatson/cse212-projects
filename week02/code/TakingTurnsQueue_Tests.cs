...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue was initialized with incorrect syntax and used .Length and .IsEmpty instead of .Count
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: No condition was set for people with 0 turns.
    ...
    // Defect(s) Found: No condition was set for people with a negative number of turns.
